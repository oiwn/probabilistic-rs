...
fn bench_redb_snapshots(c: &mut Criterion) {
    let mut group = c.benchmark_group("redb_snapshot_operations");
...
fn bench_redb_snapshot_fill_levels(c: &mut Criterion) {
    let mut group = c.benchmark_group("redb_snapshot_fill_levels");
...
fn bench_redb_multi_level_snapshots(c: &mut Criterion) {
...
criterion_group!(
    benches,
    bench_redb_snapshots,
    bench_redb_snapshot_fill_levels,
    bench_redb_multi_level_snapshots
);
